...
public class employeeFormController {
    ...
    @FXML
    private JFXTextField employeeemailtxt;

    @FXML
    private JFXTextField employeepasswordtxt;

    @FXML
    void btnemployeeloginOnaction(ActionEvent event) {
        // Get input values from text fields
        String email = employeeemailtxt.getText();
        String password = employeepasswordtxt.getText();
